...
export enum checkReqArgsTarget {
    BalanceArgs = 'neo2.check.BalanceArgs',
    StorageArgs = 'neo2.check.StorageArgs',
    InvokeReadArgs = 'neo2.check.InvokeReadArgs',
    InvokeReadMultiArgs = 'neo2.check.InvokeReadMultiArgs',
    VerifyMessageArgs = 'neo2.check.VerifyMessageArgs',
    TransactionInputArgs = 'neo2.check.TransactionInputArgs',
    InvokeArgs = 'neo2.check.InvokeArgs',
    InvokeMultiArgs = 'neo2.check.InvokeMultiArgs',
}
